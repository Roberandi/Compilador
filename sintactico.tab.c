...
static const char *const yytname[] =
{
  ...
  "FLOAT", "PRINT", "ASSIGN", "SEMICOLON", "LPAREN", "RPAREN", "ERROR",
  "$accept", "programa", "sentencias", "sentencia", YY_NULLPTR
};
...
{
       1,     2,     4,     6,     3,    10,     0,    -1,    -1,    11,
       5,    13,    -1,    -1,     8,    -1,     7,    -1,    12,    -1
};
...
{
       0,     1,     3,     5,     7,    14,    15,    16,     9,     8,
       3,    10,     0,    16,     4,     9,     3,     9,    11,     9
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    13,    14,    15,    15,    16,    16,    16,    16
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* sentencia: INT ID SEMICOLON  */
#line 39 "sintactico.y"
                     {
        if(!buscar_variable((yyvsp[-1].texto))) {
            printf("[LOG] ✔ Semantica: '%s' declarada con exito.\n", (yyvsp[-1].texto));
            agregar_variable((yyvsp[-1].texto));
        } else {
            printf("[LOG] ❌ Error Semantico: La variable '%s' ya existe.\n", (yyvsp[-1].texto));
        }
    }
#line 1104 "sintactico.tab.c"
    break;

  case 6: /* sentencia: ID ASSIGN NUM SEMICOLON  */
#line 47 "sintactico.y"
                              {
        if(buscar_variable((yyvsp[-3].texto))) {
...
#line 1117 "sintactico.tab.c"
  ...
  case 7: /* sentencia: PRINT LPAREN ID RPAREN SEMICOLON  */
#line 55 "sintactico.y"
                                       {
        if(buscar_variable((yyvsp[-2].texto))) {
...
#line 1130 "sintactico.tab.c"
  ...
  case 8: /* sentencia: error SEMICOLON  */
